			...
			<div class="flex flex-col items-center justify-center">
				<div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 w-full md:w-2/3 lg:w-1/2 ">
					<div class="inline-block w-full py-2 align-middle ">
						...
						<form method="POST" action="{{ route('treinadores.store') }}">
							@csrf
							...
							<div class="mt-4">
									...
									<x-input id="telemovel" class="block mt-1 w-full" type="tel" name="telemovel" :value="old('telemovel')" required />
							</div>
							...
							<div class="mt-4">
								...
								<select name="genero" id="genero" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required v-model="old('genero')">
