					...
					<div class="inline-block w-full py-2 align-middle ">
						...
						<form method="POST" action="{{ route('membros.update', $membro) }}">
							...
							<div>
									...
									<x-input id="nome" class="block mt-1 w-full" type="text" name="nome" value="{{ $membro->nome_completo}}" required autofocus />
							</div>
							...
							<div class="mt-4">
									...
									<x-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{ $membro->email }}" required />
							</div>
							...
							<div class="mt-4">
									...
									<x-input id="telemovel" class="block mt-1 w-full" type="tel" name="telemovel" value="{{ $membro->telemovel }}" required />
							</div>
							...
							<div class="mt-4">
									...
									<x-input id="data_NS" class="block mt-1 w-full"
										type="date"
										name="data_NS"
										required value="{{ $membro->data_de_nascimento }}"/>
							</div>
							...
							<div class="mt-4">
									...
									<x-input id="address" class="block mt-1 w-full"
																	type="text"
																	name="address" required value="{{ $membro->endereco }}"/>
							</div>
							<div class="flex items-center justify-between mt-4">
									<a class="inline-flex items-center text-center px-4 py-2 text-sm bg-red-400 text-white rounded-md" href="{{ route('membros.index') }}">
											{{ __('Cancelar') }}
									</a>
