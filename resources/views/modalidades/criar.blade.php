					...
					<div class="inline-block w-full py-2 align-middle ">
						...
						<form method="POST" action="{{ route('modalidades.store') }}">
							...
							<div class="mt-4">
								...
								<select name="status" id="status" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required v-model="old('status')">
